...
@app.route('/cloud/ac_control/get_cloud_wh', methods=['GET'])
def get_cloud_data_to_queue():
    return DataHolder.getInstance().get_cloud_wh_data()


@app.route('/cloud/ac_control/add_cloud_bh', methods=['POST'])
def add_cloud_data_to_queue():
    record = json.loads(request.data)
...
@app.route('/cloud/ac_control/get_cloud_bh', methods=['GET'])
def get_cloud_data_to_queue():
    return DataHolder.getInstance().get_cloud_bh_data()


@app.route('/cloud/ac_control/add_cloud_wo', methods=['POST'])
def add_cloud_data_to_queue():
    record = json.loads(request.data)
...
@app.route('/cloud/ac_control/get_cloud_wo', methods=['GET'])
def get_cloud_data_to_queue():
    return DataHolder.getInstance().get_cloud_wo_data()


@app.route('/cloud/ac_control/add_cloud_bo', methods=['POST'])
def add_cloud_data_to_queue():
    record = json.loads(request.data)
...
@app.route('/cloud/ac_control/get_cloud_bo', methods=['GET'])
def get_cloud_data_to_queue():
    return DataHolder.getInstance().get_cloud_bo_data()


@app.route('/cloud/ac_control/add_cloud_accuracy', methods=['POST'])
def add_cloud_data_to_queue():
    record = json.loads(request.data)
...
@app.route('/cloud/ac_control/get_cloud_accuracy', methods=['GET'])
def get_cloud_data_to_queue():
