...
def get_x_train_data():
    try:
        req = requests.get("http://localhost:4001/speed/x_train")
...
def get_y_train_data():
    try:
        req = requests.get("http://localhost:4001/speed/y_train")
        decodedArrays = json.loads(req.text)
...
def get_x_test_data():
    try:
        req = requests.get("http://localhost:4001/speed/x_test")
        decodedArrays = json.loads(req.text)
...
def get_input_data():
    try:
        req = requests.get("http://localhost:4001/speed/input")
        decodedArrays = json.loads(req.text)
