...
def get_roof_wh():
    try:
        req = requests.get("http://localhost:3003/roof/wh")
        decodedArrays = json.loads(req.text)
...
def get_roof_bh():
    try:
        req = requests.get("http://localhost:3003/roof/bh")
        decodedArrays = json.loads(req.text)
...
def get_roof_wo():
    try:
        req = requests.get("http://localhost:3003/roof/wo")
        decodedArrays = json.loads(req.text)
...
def get_roof_bo():
    try:
        req = requests.get("http://localhost:3003/roof/bo")
        decodedArrays = json.loads(req.text)
